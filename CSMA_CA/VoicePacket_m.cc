//
// Generated file, do not edit! Created by nedtool 5.7 from VoicePacket.msg.
//
...
void VoicePacket::copy(const VoicePacket& other)
{
    ...
    this->delayground = other.delayground;
...
void VoicePacket::parsimPack(omnetpp::cCommBuffer *b) const
{
    ...
    doParsimPacking(b,this->delayground);
...
void VoicePacket::parsimUnpack(omnetpp::cCommBuffer *b)
{
    ...
    doParsimUnpacking(b,this->delayground);
...
double VoicePacket::getDelayground() const
{
    return this->delayground;
}

void VoicePacket::setDelayground(double delayground)
{
    this->delayground = delayground;
}
...
int VoicePacketDescriptor::findField(const char *fieldName) const
{
    ...
    if (fieldName[0]=='d' && strcmp(fieldName, "delayground")==0) return base+3;
...
std::string VoicePacketDescriptor::getFieldValueAsString(void *object, int field, int i) const
{
    ...
    switch (field) {
        ...
        case 3: return double2string(pp->getDelayground());
...
bool VoicePacketDescriptor::setFieldValueAsString(void *object, int field, int i, const char *value) const
{
    ...
    switch (field) {
        ...
        case 3: pp->setDelayground(string2double(value)); return true;
